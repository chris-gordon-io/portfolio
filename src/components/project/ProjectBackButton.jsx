    ...
    <div className="pb-wrapper" data-dev-component="Back Button">
      <Link to="/" className="pb-button">
        ...
        <svg className="pb-button-arrow" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
          <line x1="2" y1="8" x2="14" y2="8" stroke="#ffffff" strokeWidth="1.5" strokeLinecap="round"/>
          <polyline points="9,4 14,8 9,12" fill="none" stroke="#ffffff" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
      </Link>
    </div>
  )
