  ...
  return (
    <div className="p1-page">
      ...
      <ProjectText heading="About">
        <p className="body">Motorway started in 2017 with a vision to build a better car market for everyone, operating in a very competitive market against companies such as Carwow, Webuyanycar and Cinch.</p>
        <p className="body">I joined Motorway in summer 2023 and after an "easy in" learning the way the company works on internal tools was moved over to the Growth team tasked with optimising top of funnel — in this case the first four pages a (new) user would see when landing on Motorway.co.uk with the intent of (potentially) selling their car.</p>
      </ProjectText>

      <ProjectText heading="Heuristic evaluation of current experience">
        <p className="body">The first thing I did when joining this team was to go through the current experience and making some potentially quick and easy optimisation recommendations, these included things such as:</p>
        <div>
          <p className="body">✅ Making sure CTA's were visible across all viewports</p>
          <p className="body">✅ One Primary CTA on each page</p>
          <p className="body">✅ Increase Accessibility of form fields</p>
        </div>
        <p className="body">I shared the findings with the wider team (Lead Product Owner and full Dev team) to gauge thoughts and feelings as well as get a rough idea of effort involved (from an engineering perspective).</p>
        <p className="body">With the whole team aligned we wrote up tickets for refinement and rolled out each optimisation separately and measuring impact.</p>
      </ProjectText>
      ...
      <ProjectText heading="Addition action">
        <p className="body">Off the back of this we also rebuilt the header to reduce the amount of space it took up as during User Lab testing people were aware and confident that the valuation was related to the car details they had inputted and act as an enabler for more space for more valuable content.</p>
      </ProjectText>
      ...
      <ProjectText heading={<>Problem/Opportunity space <span className="pc-heading-light">(where and why)</span></>}>
        <p className="body">A previous study and continual discovery (through moderated user testing) pointed to 3 key drivers for users to sell their car to design to:</p>
        <div>
          <p className="body">💰 Price (how much)</p>
          <p className="body">💰 Price (how did MW get this price and can I trust I will get it)</p>
          <p className="body">⚙️ Process (Understanding/Confidence in what happens next)</p>
        </div>
        <p className="body">Looking at our funnel data we had two big opportunity spaces, the home page and the offer select page (offer select page being the larger of the two based on the numbers 15.3% vs 30.3% vs Previous). The Home page had recently been fully redesigned and A/B tested on with little to no impact so there was little appetite to focus on that for now.</p>
      </ProjectText>
      ...
      <ProjectText heading="How we tackled this">
        <p className="body">To kick this new focus off I ran a team wide workshop to pull in everyone's knowledge, opinions and ideas around the current experience.</p>
      </ProjectText>
      ...
      <ProjectText heading="Creating a North Star">
        <p className="body">Off the back of the team workshops and research gathering sessions I started to create a North Star vision for the offer select page, focussing on why the page exists, identifying value for users, while making it achievable within a rough year timeframe.</p>
      </ProjectText>
      ...
      <ProjectText heading="How are we going to get there?">
        <p className="body">I broke down each element of the offer select page and mapped it out to a testable plan to work out our path to our North Star, validating and understanding the value of each element along the way.</p>
      </ProjectText>
      ...
      <ProjectText heading="How we got the price modal and button">
        <p className="body">All research pointed strongly towards customers wanting to know more about how the price quoted was got (as well as questions around how it relates to their specific car). We already had an explainer "?" but it wasn't tagged up to track interaction and also did not pass accessibility colour contrast checks.</p>
      </ProjectText>
      ...
      <ProjectText heading="How we got there">
        <div>
          <p className="body">✅ Rebuilt current experience on new tech stack to enable tracking, also make sure icon passes colour contrast checks.</p>
          <p className="body">✅ Measure current interaction and conversion rates on rebuild.</p>
          <p className="body">✅ 50/50 A/B test live and proposed.</p>
        </div>
      </ProjectText>
      ...
      <ProjectText heading="Next">
        <p className="body">Continuing our journey towards our North Star and a whole new experience.</p>
